...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
            ...
            <form role="form" method=POST enctype=multipart/form-data> <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" value="{{ $employee->date_of_employment }}" name="date_of_employment" class="form-control datetimepicker-input" data-target="#reservationdate" />
        ...
        <div id="error-box">
            ...
            <div class="alert alert-danger">{{ json_encode($error,true) }}</div>
            @endforeach
        </div>
        @endif
        </form>
